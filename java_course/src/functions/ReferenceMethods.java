...
/*
 * Method References â€” a shorter form of lambda when the lambda just calls
 ...
 *
 *   2. Instance method on a specific object â†’ object::method
 *      lambda: x -> System.out.println(x)
 *      ref:    System.out::println
 *
 *   3. Instance method on a type      â†’ ClassName::instanceMethod
 ...
 * it with a method reference â€” same behavior, cleaner code.
 */
public class ReferenceMethods {
    public static void main(String[] args) {
        List<String> names = List.of("alice", "bob", "charlie");

        // 1. Static method reference â†’ Integer::parseInt
        ...
        // 2. Instance method on a specific object â†’ System.out::println
        // Equivalent lambda: name -> System.out.println(name)
        names.forEach(System.out::println); // alice / bob / charlie

        // 3. Instance method on a type â†’ String::toUpperCase
        ...
        // 4. Constructor reference â†’ StringBuilder::new
