 ...
 *   1. Runnable          â€” lambda with no parameters
 *   2. Consumer<String>  â€” lambda with one parameter, returns nothing
 *   3. BiFunction        â€” lambda with two parameters, returns a value
 *   4. Function (block)  â€” multi-line lambda with { } and return
 *   5. List.forEach/sort â€” lambdas applied to collections
 *   6. Predicate         â€” lambda that returns true/false
 *   7. Method reference  â€” shortest form (System.out::println)
 */
public class LambdaExpression {
    public static void main(String[] args) {

        // 1. Runnable â€” no parameters, no return value
        ...
        // 4. Function with a block body â€” multiple statements need { } and return
        ...
        // 5. Lambdas with collections â€” forEach and sort
        List<String> names = new ArrayList<>(List.of("Charlie", "Alice", "Bob"));
        names.forEach(name -> System.out.println("Name: " + name));
        names.sort((a, b) -> a.compareTo(b));
        System.out.println("Sorted: " + names); // [Alice, Bob, Charlie]

        // 6. Predicate â€” returns true / false
        ...
        // 7. Method reference â€” shortest form, equivalent to (x) ->
