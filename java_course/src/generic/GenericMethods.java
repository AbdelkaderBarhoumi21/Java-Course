 ...
 *
 * Example 1 â€” printArray: works with any array type (Integer, String, ...)
 *   Integer[] numbers = {1, 2, 3};
 *   Utils.printArray(numbers);            // 1 2 3
 *   Utils.printArray(new String[]{"A","B","C"}); // A B C
 *
 * Example 2 â€” max: returns the greater of two values, T must be Comparable
 *   Utils.max(10, 20);                    // 20
...
public class GenericMethods {
    public static void main(String[] args) {
        ...
        // Example 1 â€” generic method without constraint
        Utils.printArray(numbers); // 1 2 3
        Utils.printArray(words); // A B C

        // Example 2 â€” generic method with Comparable constraint
...
class Utils {
    ...
    // With constraint â€” T must implement Comparable
