 ...
 *
 * A sealed class or interface restricts which other classes or interfaces may extend it.
 ...
 * - non-sealed     : A permitted subclass is open for further extension (no restrictions).
...
public class sealed_class {
    ...
    public static void describe(Shape s) {
        // Exhaustive switch — no default needed because the compiler
...
/// Final subclass — cannot be extended any further.
...
/// Non-sealed subclass — open for further extension by other classes.
